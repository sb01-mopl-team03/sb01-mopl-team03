...
public class ContentSearchService {
  ...
  public List<Content> findContentsByKeyword(String keyword) {
    try {
      ...
      SearchResponse<ContentSearch> response = openSearchClient.search(searchRequest,
          ContentSearch.class);
      ...
      log.error("OpenSearch 검색 실패, 폴백 검색 사용: {}", e.getMessage());
  ...
  public void indexContent(Content content) {
    try {
      ...
      log.info("OpenSearch 인덱싱 성공 - ID: {}, 제목: '{}'", content.getId(), content.getTitle());
    } catch (Exception e) {
      log.error("OpenSearch 인덱싱 실패 - ID: {}, 제목: '{}', 오류: {}",
  ...
  public void deleteContent(UUID contentId) {
    try {
      ...
      log.info("OpenSearch 문서 삭제 성공: ID '{}'", contentId);
    } catch (Exception e) {
      log.error("OpenSearch 문서 삭제 실패 - ID: '{}', 오류: {}",
