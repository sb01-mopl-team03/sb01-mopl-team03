...
public interface WatchRoomApi {
  ...
  @GetMapping
  ResponseEntity<CursorPageResponseDto<WatchRoomDto>> getAll(
  ...
  @GetMapping("/{roomId}")
  ResponseEntity<WatchRoomDto> getWatchRoom(
  ...
  @ApiResponse(responseCode = "201", description = "생성 성공",
      content = @Content(schema = @Schema(implementation = WatchRoomDto.class)))
  @PostMapping
  ResponseEntity<WatchRoomDto> createWatchRoom(@RequestBody WatchRoomCreateRequest request);
}
